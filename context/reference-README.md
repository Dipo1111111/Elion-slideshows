# Slidesmith (REFERENCE — read-only)

> This is the **feature reference** for the Elion rebuild. SlideSmith is licensed **PolyForm Noncommercial** — its code, prompts, and images may NOT be copied into Elion. Use this document to understand the feature surface we're rebuilding from scratch.
